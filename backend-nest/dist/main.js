    ...
    (0, common_1.Module)({
        imports: [platform_express_1.MulterModule.register({
            ...
            serve_static_1.ServeStaticModule.forRoot({
                rootPath: (0, path_1.join)(__dirname, '..', 'www8'),
            })],
...
let ThreeDViewerController = class ThreeDViewerController {
    ...
    displayThreeD(response, request) {
        console.log((0, path_1.join)(process.cwd(), '../backend-nest/MODEL/3dViewer.html'));
        response.sendFile((0, path_1.join)(process.cwd(), '../backend-nest/MODEL/3dViewer.html'));
    }
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("796964f7e028a6a2c3e1")
/******/ 	})();
/******/ 	
