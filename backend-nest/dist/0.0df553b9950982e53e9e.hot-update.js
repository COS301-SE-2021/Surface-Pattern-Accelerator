...
let CreateAccessTokenController = class CreateAccessTokenController {
    ...
    createAccessToken(session, request) {
        session.accessToken = {
            access_token: request.body.Zb.access_token,
...
__decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof Record !== "undefined" && Record) === "function" ? _a : Object, typeof (_b = typeof Request !== "undefined" && Request) === "function" ? _b : Object]),
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("469b4edc24635126d096")
/******/ })();
/******/ 
/******/ }
;